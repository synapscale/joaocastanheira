  ...
  return (
    <Popover open={isOpen} onOpenChange={setIsOpen}>
      <PopoverTrigger asChild>
        ...
        >
          <span className="text-blue-500 dark:text-gray-400 mr-1 text-sm">❄</span>
          <span className="text-sm font-medium">{buttonLabel || selectedOption.name || selectedOption.label}</span>
